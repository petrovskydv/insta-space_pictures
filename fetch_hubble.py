...
def fetch_hubble_images_from_collection(collection_name, source_path, processed_images_path):
    ...
    for image in images:
        fetch_hubble_image(image['id'], source_path, processed_images_path)


def fetch_hubble_image(image_id, source_path, processed_images_path):
